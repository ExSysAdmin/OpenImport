...
Public Class RegExPatterns
    ...
    Private Sub RegExPatterns_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles xDeleteBtn.Click
        Try
            For Each Pattern In PatternList
                If Pattern.Id = PatternGridView.SelectedRows(0).Cells(0).Value Then
                    PatternList.Remove(Pattern)
